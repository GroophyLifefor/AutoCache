...
public:
	...
	void dbgPrint(string text)
	{
		...
		/*[CLIENT]: Game message: action|log
msg|`4UPDATE REQUIRED!`` : The `$V3.71`` update is now available for your device.  Go get it!  You'll need to install it before you can play online.
[CLIENT]: Game message: action|set_url
url|https://ubistatic-a.akamaihd.net/0098/08705/GrowtopiaInstaller.exe
